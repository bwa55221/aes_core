...
def generate_aes_top(aes_mode = '128', aes_n_rounds = 1, pipe_stage=0, filepath=os.getcwd()):
    filename = os.path.join(filepath,'top_aes_gcm.vhd')
...
if __name__ == "__main__":
    generate_aes_top(aes_mode = '128', aes_n_rounds = 10)