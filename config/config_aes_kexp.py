...
def generate_aes_kexp_logic(key_n_bits = 128, n_rounds = 1, filepath=os.getcwd()):
    filename = os.path.join(filepath,'aes_kexp.vhd')
...
if __name__ == "__main__":
    generate_aes_kexp_logic(key_n_bits='128', n_rounds=10)